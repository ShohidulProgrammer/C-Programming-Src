...
int choice,number_of_retailers,number,temp,n,i,flag,level,placefound;
...
void sorting();
void sorting_id();								// This Function would place the node at its particular location after sorting on the basis of level(1st) and name wise(2nd)
